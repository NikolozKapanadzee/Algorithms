...
//     company: {
//       name: "Deckow-Crist",
//       catchPhrase: "Proactive dpriceactic contingency",
...
//   (user) => user.username.toLocaleLowerCase().length <= 8,
// );
// console.log(index);

// const totalPrice = users.reduce((total, current) => total + current.price, 0);
// console.log(totalPrice);

// const grouped = users.reduce((total, current) => {}, {});
...
//       obj[city] = [];
//     }
//     obj[city].push(users[i]);
//   }
//   console.log(obj);
// }
// groupBy(users);

// const index = users.findIndex((user) => user.email === "Sherwood@rosamond.me");
...
//   let eachCurrency = transations[i].currency;
//   let eachAmount = transations[i].amount;

//   console.log(eachCurrency);
//   console.log(eachAmount);

//   if (!result[eachCurrency]) {
//     result[eachCurrency] = [];
//   }
//   result[eachCurrency].push(eachAmount);
// }
// console.log(result);
...
// const user1 = new User("Sasha", 21);
// const user2 = new User("Julia", 40);
